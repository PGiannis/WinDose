...
class Contacts extends JFrame implements ActionListener {
    ...
    Patient patient;
	    ...
	    public Contacts(Patient patient)	{
	    ...
	    public void actionPerformed(ActionEvent e) {
	    	if (e.getSource() == sub) {
	    		try {
		        	patient.writePatientToDB();
		        } catch (Exception ex) {
		        	System.out.println(ex.getMessage());
		        }
	    		if (!Contact1.getText().equals("") && !Phone1.getText().equals("")) {
	    			Contact c = new Contact(Contact1.getText(), Phone1.getText(), patient);
	    			try {
						c.writeContactToDB();
					} catch (Exception e1) {
						e1.printStackTrace();
	    		...
	    		if (!Contact2.getText().equals("") && !Phone2.getText().equals("")) {
	    			Contact c = new Contact(Contact2.getText(), Phone2.getText(), patient);
	    			try {
						c.writeContactToDB();
					} catch (Exception e1) {
						e1.printStackTrace();
	    		...
	    		if (!Contact3.getText().equals("") && !Phone3.getText().equals("")) {
	    			Contact c = new Contact(Contact3.getText(), Phone3.getText(), patient);
	    			try {
						c.writeContactToDB();
					} catch (Exception e1) {
						e1.printStackTrace();
	    		...
	    		if (!Contact4.getText().equals("") && !Phone4.getText().equals("")) {
	    			Contact c = new Contact(Contact4.getText(), Phone4.getText(), patient);
	    			try {
						c.writeContactToDB();
					} catch (Exception e1) {
						e1.printStackTrace();
	    		...
	    		if (!Contact5.getText().equals("") && !Phone5.getText().equals("")) {
	    			Contact c = new Contact(Contact5.getText(), Phone5.getText(), patient);
	    			try {
						c.writeContactToDB();
					} catch (Exception e1) {
						e1.printStackTrace();
	    		...
	    		if (!Contact6.getText().equals("") && !Phone6.getText().equals("")) {
	    			Contact c = new Contact(Contact6.getText(), Phone6.getText(), patient);
	    			try {
						c.writeContactToDB();
					} catch (Exception e1) {
						e1.printStackTrace();
